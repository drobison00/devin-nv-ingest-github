...
def parse_json_string_to_blob(json_content):
    ...
    try:
        ...
        def sorting_key(entry):
            page = entry['metadata']['content_metadata']['hierarchy']['page']
...
def process_json_files(json_files, output_file):
    """
    ...
    try:
        ...
        blob_string = parse_json_string_to_blob(combined_content)
